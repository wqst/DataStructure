...
class Shape : public Drawable
{
  ...
  public:
     ...
     */
    Shape(const Vector2& center, const epng::rgba_pixel& color);
     ...
     *
     * @return the epng::rgba_pixel representing the color of the Shape
     */
    epng::rgba_pixel color() const;

    void draw(epng::png& canvas) const;
};
